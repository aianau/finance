...
def run_benchmark(exe_path: str, scenario: str, threads: int = 2, events: int = 100000,
                  ...
                  read_write_ratio: int = 2, bimodal: bool = False) -> str:
    cmd = [
        exe_path,
        '--scenario', scenario,
        '--threads', str(threads),
...
def main():
    ...
    parser.add_argument('--bimodal', action='store_true',
                       help='Use bimodal distribution (95%% small, 5%% large events)')
    ...
    print(f"Distribution mode: {'Bimodal (95% small, 5% large)' if args.bimodal else 'Uniform'}")
    print(f"\nParameters:")
